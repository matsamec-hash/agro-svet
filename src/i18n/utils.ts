...
export const LAUNCHED_PREFIXES: Record<Locale, string[]> = {
  ...
  pl: ['/stroje', '/znacky', '/srovnani', '/slovnik', '/puda', '/statistiky', '/data', '/kalkulacka/prevody-jednotek', '/kalkulacka/prevody-hmotnost', '/doplaty-bezposrednie', '/ekoschematy', '/encyklopedie'],
};
