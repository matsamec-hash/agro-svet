...
Mateří mřížku je třeba pravidelně čistit od propolisu, který dělnice ucpávají otvory.`,
  ...
  },
  {
    ...
    longDef: `Mateří kašička je výživná látka bílé až slabě nažloutlé barvy s charakteristicky kyselou chutí. Obsahuje přibližně 60–70 % vody, 12–15 % bílkovin (zejm. MRJP — major royal jelly proteins, hlavní bílkoviny mateří kašičky, z nichž klíčový je MRJP1 zvaný royalactin), 5–6 % cukrů, 3–6 % lipidů a různé vitaminy skupiny B.
...
Kontrola kladení je základní metodou diagnostiky bezmatečnosti — pouhý pohled na plást (přítomnost vajíček viditelných lupou nebo na slunci) potvrdí přítomnost aktivní matky. Vajíčko je čerstvé, starší larrvy a zavíčkovaný plod mohou pocházet z předchozí matky.`,
  ...
  },
  {
    ...
    longDef: `Varroa destructor — druh oddělený od Varroa jacobsoni v roce 2000; V. jacobsoni napadá pouze včelu východní (Apis cerana) — je ektoparazitický roztoč původem z Asie, který se šíří celosvětově a prakticky v každé populaci včely medonosné v Evropě. Samička (1,1 × 1,6 mm, červenohnědá, oválná) se přichycuje na kuklu nebo dospělou včelu a saje hemolymfu.
...
Monitoring se provádí přirozeným spadem na podložce, zimní prací s 100 včelami nebo alkoholovým omýváním (wash). Práh léčení je zpravidla 3 % roztoče na dělnicích nebo 0,5 roztoče/100 dělnic (WHO doporučení).`,
  ...
  },
  {
    ...
    longDef: `Kleštík včelí je systematicky zařazen do řádu Acarina (pavoukovci), čeledi Varroidae. Vědecký název Varroa destructor byl ustaven v roce 2000, kdy byl druh oddělen od Varroa jacobsoni — ten napadá pouze včelu východní (Apis cerana) a na včele medonosné se nerozmnožuje. Samička je oploštělá, hnědočervená, přibližně 1,1 mm dlouhá a 1,6 mm široká. Je viditelná pouhým okem na těle včely nebo ve spadu na úlové podložce.
...
V nástavkových úlech se běžně používá 10 rámků na nástavek, přičemž okrajový prostor je mírně větší (8–10 mm od stěny úlu).`,
  ...
  },
  {
    ...
    kategorie: 'vcelarstvi',
    shortDef: 'Dymák je nástroj na výrobu chladného hustého kouře, který se při práci s včelstvem aplikuje do česna a pod víko úlu, aby se snížila agresivita včel.',
...
Kočovné včelstvo musí být zdravé a ošetřené — SVS vydává kočovací průkazy, které veterinárně stvrzují zdravotní stav včelstva. Bez platného průkazu nelze legálně přesouvat úly v ČR.`,
  ...
  },
  {
    slug: 'cmsch',
    term: 'ČMSCH',
    alias: ['Českomoravská společnost chovatelů', 'ústřední evidence včelstev'],
    kategorie: 'vcelarstvi',
    shortDef: 'ČMSCH (Českomoravská společnost chovatelů, a.s.) je ústřední evidenční a registrační orgán včelstev v ČR — každý chovatel je povinen hlásit počty včelstev a stanoviště do ČMSCH. Hlavní zájmovou organizací včelařů je Český svaz včelařů (ČSV).',
    longDef: `Českomoravská společnost chovatelů, a.s. (ČMSCH) provozuje Ústřední evidenci hospodářských zvířat (UEHO). V oblasti včelařství to znamená, že každý chovatel musí nahlásit do ČMSCH svá stanoviště a počty včelstev — tato data slouží pro veterinární dohled (monitoring nákaz, varroáza) a pro výpočet dotačních nároků ze SZIF.

Hlavní zájmovou organizací sdružující včelaře je Český svaz včelařů (ČSV), který zajišťuje vzdělávání, poradenství, pojištění a zastupování zájmů včelařů vůči státním orgánům. ČSV má krajské a místní organizace po celé ČR.

Šlechtitelský program a vedení plemenné knihy pro včelu medonosnou koordinuje Český svaz chovatelů včely medonosné (ČSCHV) ve spolupráci s ověřovacími stanicemi. Program zahrnuje hodnocení výnosnosti, klidnosti, rojivosti a VSH hygieny (Varroa Sensitive Hygiene).

Dotace pro včelaře v ČR jsou spravovány SZIF v rámci národních podpor — zejm. dotace na přezimování včelstev a opatření na boj s varroázou.`,
...
Posouzení aktivity česna je rychlou diagnostikou zdraví včelstva: aktivní pohyb dělnic s rouskami pylu v ranních hodinách signalizuje silné, aktivní plodiště; mrtvé nebo nehybné české signalizuje problém.`,
  ...
  },
  {
    ...
    kategorie: 'vcelarstvi',
    shortDef: 'Medocukrové těsto (kandy) je tuhé zimní krmivo ze cukru, medu a vody, které se pokládá na rámky k doplnění zásoby v zimě nebo brzy na jaře.',
...
Systémy oplodnáčků jsou standardizovány (Apidea, Kirchhain, Nicot) — vzájemná zaměnitelnost a snadná manipulace jsou výhodami, nevýhodou je náročnost přepravy a slabší zásoby při špatném počasí.`,
  ...
  },
  {
    ...
    longDef: `Trubčina se pozná od dělnického plodu jak vizuálně (buňky mají větší průměr a jsou kupolovitě vyklenuté, takže zavíčkovaný trubčí plod výrazně přečnívá z plochy plástu), tak rozměrově. Matka klade do trubčích buněk neoplodněná vajíčka záměrně — rozpozná velikost buňky zadečkovými senzory.
