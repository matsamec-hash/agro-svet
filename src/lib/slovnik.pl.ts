...
export const SLOVNIK_PL: SlovnikTerm[] = [
  ...
  },
  {
    ...
    "longDef": "Wspólna Polityka Rolna (WPR, ang. CAP — Common Agricultural Policy) to główny instrument finansowy UE wspierający rolnictwo. Obecny okres 2023–2027 przyniósł zasadniczą reformę — większy nacisk na ekologię (zazielenianie), redystrybucję na korzyść mniejszych gospodarstw i ochronę zasobów naturalnych. Główne elementy dla ČR (orientacyjne stawki 2024):\n1. **BISS** (Basic Income Support for Sustainability) — Płatność podstawowa, według stawki ogłoszonej przez ARiMR na dany rok na wszystkie kwalifikujące się powierzchnie.\n2. **CISS** (Complementary Redistributive Income Support) — Płatność redystrybucyjna, według stawki ogłoszonej przez ARiMR na dany rok dla pierwszych 150 ha. Wspiera małe gospodarstwa.\n3. **Płatność EKO** (Eco-scheme) — Podstawowawedług stawki ogłoszonej przez ARiMR na dany rok, premiumwedług stawki ogłoszonej przez ARiMR na dany rok za więcej praktyk ekologicznych (międzyplony, pasy bioróżnorodności, powierzchnie nieprodukcyjne).\n4. **ANC** (Areas with Natural Constraints) — Obszary o niekorzystnych warunkach, górskiewedług stawki ogłoszonej przez ARiMR na dany rok, OA/SVwedług stawki ogłoszonej przez ARiMR na dany rok.\n5. **Młody rolnik** — Premiawedług stawki ogłoszonej przez ARiMR na dany rok dla pierwszych 150 ha (do 40 lat, maks. 5 lat).\n6. **VCS** (Voluntary Coupled Support) — Sektory wrażliwe: chmielwedług stawki ogłoszonej przez ARiMR na dany rok, warzywa polowewedług stawki ogłoszonej przez ARiMR na dany rok, burak cukrowywedług stawki ogłoszonej przez ARiMR na dany rok, owocewedług stawki ogłoszonej przez ARiMR na dany rok, ziemniaki na skrobięwedług stawki ogłoszonej przez ARiMR na dany rok, białkawedług stawki ogłoszonej przez ARiMR na dany rok, lenwedług stawki ogłoszonej przez ARiMR na dany rok, paszowewedług stawki ogłoszonej przez ARiMR na dany rok. Wniosek składa się jednorazowo w Wniosku Zbiorczym (zazwyczaj kwiecień–czerwiec, elektronicznie przez Portal Rolnika SZIF). Wiążące stawki SZIF publikuje po zamknięciu kampanii. Do orientacyjnego wyliczenia: [Kalkulator dotacji CAP](/kalkulacka/dotace-cap/).",
    "alias": [
  ...
  },
  {
    ...
    "term": "Płatność EKO",
    "kategorie": "dotace",
    "shortDef": "Płatność EKO to część CAP 2024 wspierająca praktyki ekologiczne. Stawka podstawowa i premiowa ogłaszane są na każdy rok osobno; premiowa przysługuje za większą liczbę działań ekologicznych.",
    "longDef": "Płatność EKO (Eco-scheme) to dobrowolna część płatności bezpośrednich CAP 2024, która nagradza rolników za praktyki korzystne dla środowiska wykraczające poza obowiązkowe warunkowości. Dwa systemy w ČR:\n1. **Podstawowy system EKO** — według stawki ogłoszonej przez ARiMR na dany rok. Obowiązkowe działania, takie jak zróżnicowany płodozmian, kary za monokultury, przestrzeganie elementów krajobrazowych.\n2. **Premium system EKO** — według stawki ogłoszonej przez ARiMR na dany rok. Wymaga dodatkowo: - Min. 7% EFA (Ecological Focus Areas) z gruntów ornych — międzyplony + pasy bioróżnorodności + elementy krajobrazowe. - Zasady strefowe wzdłuż cieków wodnych (min. 3 m bez pestycydów). - Jakościowe okrywy lub ściernisko przez zimę. Bez co najmniej podstawowego systemu EKO gospodarstwo traci znaczną część płatności bezpośrednich — dlatego w praktyce 95%+ rolników jest w systemie EKO. Do kalkulacji: różnica między podstawowym a premium towedług stawki ogłoszonej przez ARiMR na dany rok. Dla gospodarstwa 200 ha =według stawki ogłoszonej przez ARiMR na dany rok więcej. Jeśli wdrożenie praktyk premium (nasiona na międzyplony, siew, koszenie pasów) kosztuje <według stawki ogłoszonej przez ARiMR na dany rok, opłaca się. W praktyce wynik premium idzie w górę (lepsza gleba, mniej erozji z warstwy ornej) — netto pozytywne nawet bez premii dotacyjnej dla długoterminowego gospodarstwa.",
    "alias": [
      "Eco-scheme",
      "zazielenianie",
      "system eko"
  ...
  },
  {
    ...
    "term": "BISS",
    "kategorie": "dotace",
    "shortDef": "BISS to główna płatność bezpośrednia CAP 2024 — według stawki ogłoszonej przez ARiMR na dany rok na wszystkie kwalifikujące się grunty rolne. Zastąpiła wcześniejszy SAPS.",
    "longDef": "BISS (Basic Income Support for Sustainability) to podstawowa płatność bezpośrednia CAP 2024 — zastępuje wcześniejszy SAPS (Single Area Payment Scheme). Wypłacana na wszystkie kwalifikujące się grunty rolne zaewidencjonowane w LPIS. Stawka 2024: według stawki ogłoszonej przez ARiMR na dany rok. Dla gospodarstwa 100 ha =według stawki ogłoszonej przez ARiMR na dany rok tylko z BISS, plus pozostałe składniki (CISS, EKO, ANC, VCS) łączniewedług stawki ogłoszonej przez ARiMR na dany rok. Warunki uprawnienia:\n1. **Aktywny rolnik** — regularna działalność rolnicza, nie tylko \"trzymanie gruntów\".\n2. **Wniosek przez Wniosek Zbiorczy SZIF** — kwiecień–czerwiec, elektronicznie przez Portal Rolnika.\n3. **Min. powierzchnia 1 ha** — poniżej tego uprawnienie nie przysługuje.\n4. **Warunkowości** — obowiązkowe praktyki GAEC + obowiązkowe wymogi zarządzania SMR (dobrostan, gleba, woda). Wypłata: SZIF wypłaca w terminach jesiennych (zazwyczaj październik–grudzień) za poprzednią kampanię. W przypadku kontroli na miejscu i stwierdzenia nieprawidłowości sankcja może wynieść 1–100% wraz ze zwrotem poprzednich płatności. Do orientacyjnego wyliczenia całkowitej dotacji: [Kalkulator dotacji CAP](/kalkulacka/dotace-cap/).",
    "alias": [
  ...
  },
  {
    ...
    "longDef": "AEKO (Działania rolno-środowiskowo-klimatyczne) to odrębny program dotacyjny w ramach WPR 2024, nagradzający 5-letnie zobowiązania do ekologicznie przyjaznych praktyk. Wyższe stawki niż schemat EKO, ale ostrzejsze zasady i sankcje za naruszenia. Główne działania AEKO w Polsce 2024:\n- **Ochrona trwałych użytków zielonych (TUZ)** — koszenie w późniejszych terminach (po wylęgu ptaków),według stawki ogłoszonej przez ARiMR na dany rok w zależności od podtypu.\n- **Pasy biocenotyczne** — mieszanki kwitnące na polu, ok.według stawki ogłoszonej przez ARiMR na dany rok (więcej niż EFA).\n- **Korytarz ekologiczny** — ciągłe linie zieleni krajobrazowej,według stawki ogłoszonej przez ARiMR na dany rok.\n- **Rolnictwo ekologiczne (RE)** — certyfikowane bio, dodatkowe stawki na hektar według uprawy.\n- **Trwały wypas** —według stawki ogłoszonej przez ARiMR na dany rok według kategorii ONW.\n- **Zwiększone zadarnianie gruntów ornych** — przekształcenie GO na TUZ, rekompensata utraconych plonów.\n- **Sady ekstensywnych gatunków owocowych** —według stawki ogłoszonej przez ARiMR na dany rok. Zasady:\n- **Umowa 5-letnia** — naruszenie = zwrot dopłat za wszystkie poprzednie lata.\n- **Niekompatybilności** — niektóre podtypy nie mogą być łączone (np. AEKO TUZ + intensywny wypas).\n- **Kontrola na miejscu** — inspekcja ARiMR 5–10% wnioskodawców rocznie + teledetekcja. Dla polskiego rolnika:\n- AEKO opłaca się, jeśli rolnik ma długoterminową strategię (nastawienie na bio, kształtowanie krajobrazu, ochronę zasobów wodnych).\n- Dla klasycznej farmy intensywnej zwrot z inwestycji bywa gorszy niż EKO premium (więcej formalności, wyższe ryzyko sankcji).\n- Wnioskodawcom zalecamy najpierw złożyć **schemat EKO premium**, a następnie stopniowo dodawać podtypy AEKO według możliwości.",
    "alias": [
      "AEKO",
      "rolno-środowiskowe"
    ],
  ...
  },
  {
    ...
    "longDef": "**Leasing finansowy** = wynajem z obowiązkową opcją wykupu na końcu (zazwyczaj za 1–5% wartości rezydualnej). **Leasing operacyjny** = wynajem bez opcji wykupu, na końcu zwracasz maszynę. Odpowiedni na krótki okres (3–5 lat), bez troski o sprzedaż. **Kredyt bankowy** = klasyczna pożyczka, maszyna jest od razu Twoja, zabezpieczenie zastawem. | | Leasing finansowy | Leasing operacyjny | Kredyt bankowy |\n|---|---|---|---|\n| **Własność podczas** | firma leasingowa | firma leasingowa | Ty (zastaw w banku) |\n| **Własność po spłacie** | Ty | firma leasingowa | Ty |\n| **VAT** | rozłożony na raty | tylko na raty (zawsze) | całość z góry |\n| **Wkład własny** | 0–30% | 0–30% | 0–20% |\n| **Oprocentowanie (2026)** | 5,5–8% r.r. | 6–9% r.r. | 5–7% r.r. |\n| **Okres** | 24–84 mies. | 24–60 mies. | 12–96 mies. |\n| **Elastyczność** | niska (kary za wcześniejsze rozwiązanie) | niska | wyższa (refinansowanie) | **Dla polskiego rolnika**:\n- **Leasing finansowy** to standard dla 70% zakupów — przewidywalność rat, optymalizacja podatkowa.\n- **Kredyt** opłaca się przy **drogich maszynach 5+ mln ** z wysokim wkładem własnym — niższy łączny koszt odsetkowy.\n- **Leasing operacyjny** jest wyjątkowy — odpowiedni dla **przedsiębiorców usług żniwnych**, którzy maszynę intensywnie eksploatują przez 5 lat, a potem zwracają. **Finansowanie captive marki** (John Deere Financial, AGROTEC FS, AGRI CS Finance):\n- Często promocyjne oprocentowanie 4–6% na nowe maszyny własnej marki.\n- Powiązane ze sprzedawcą — opłacalne łączyć z rabatem na cenie maszyny.\n- Dla używanych maszyn zazwyczaj wyższe oprocentowanie niż banki uniwersalne. → [Kalkulator leasingu ciągnika](/kalkulacka/leasing-traktoru/) do orientacyjnego wyliczenia miesięcznej raty.",
    "alias": [
      "leasing operacyjny",
      "leasing finansowy"
    ],
  ...
  },
  {
    ...
    "longDef": "Plan Strategiczny Wspólnej Polityki Rolnej (PS WPR) to wiążący dokument zatwierdzony przez Komisję UE oddzielnie dla każdego państwa członkowskiego na okres 2023–2027. **Dla ČR** definiuje budżet ~110 mld na 5-letni okres i wszystkie tytuły dotacyjne. **Struktura PS WPR ČR**: ### Filar I — Płatności bezpośrednie (~50 % budżetu):\n- **BISS** (Płatność podstawowa) według stawki ogłoszonej przez ARiMR na dany rok\n- **CISS** (Redystrybucyjna) według stawki ogłoszonej przez ARiMR na dany rok dla pierwszych 150 ha\n- **Ekoregumin** podstawowy 1300 + premium +według stawki ogłoszonej przez ARiMR na dany rok\n- **ANC** (obszary o niekorzystnych warunkach)według stawki ogłoszonej przez ARiMR na dany rok\n- **Młody rolnik** +według stawki ogłoszonej przez ARiMR na dany rok premia\n- **VCS** (sektory wrażliwe) — zmienna ### Filar II — Rozwój obszarów wiejskich (PRV):\n- **AEKO** umowy (5-letnie agro-środowiskowe)\n- **Tytuły inwestycyjne** (Interwencja 33.73, 37.73 i inne)\n- **LFA** (Less Favoured Areas — pokrywa się z ANC)\n- **Dobrostan zwierząt** — specjalne płatności\n- **Premia ekologiczna** dla rolnictwa ekologicznego\n- **Ubezpieczenie plonów** (50 % współfinansowanie państwa) **Kluczowe interwencje** (oznaczenia numeryczne w PS WPR):\n- **33.73** — Inwestycje w przedsiębiorstwa rolne (maszyny, budynki).\n- **37.73** — Technologie ograniczające emisje (nawożenie z mniejszą emisją NH₃).\n- **47.73** — Scalanie gruntów.\n- **51.73** — Młodzi rolnicy — jednorazowe wsparcie na rozpoczęcie działalności.\n- **75.73** — AEKO użytki zielone. **Dokumentacja dla wnioskodawców**:\n- **Dokument główny**: https://eagri.cz/web/mze/dotace/sp-szp-2023-2027\n- **Zasady SZIF** dla każdego tytułu oddzielnie — zawsze sprawdzać aktualną wersję (zmienia się co roku).\n- **Portal Rolnika** — elektroniczne składanie wszystkich wniosków. **Dla rolników w ČR**:\n- **Wniosek zbiorczy** (kwiecień–czerwiec) obejmuje większość płatności bezpośrednich.\n- **Dotacje inwestycyjne** mają własne nabory (typowo 2× rocznie).\n- **Umowy AEKO** zawierane na 5 lat — wejście to decyzja długoterminowa. **Kontrole**: SZIF kontroluje 1–5 % wnioskodawców na miejscu + monitoring satelitarny (Copernicus SISAEC) całego LPIS co roku.",
    "alias": [
  ...
  },
  {
    ...
    "longDef": "Interwencja 33.73 to najważniejsza dotacja inwestycyjna dla rolników w ČR. Obejmuje: **Koszty kwalifikowalne**:\n- **Maszyny i sprzęt** — ciągniki, kombajny, siewniki, opryskiwacze, prasy, żniwiarki, ładowacze.\n- **Budynki dla produkcji zwierzęcej** — obory, dojarnie, silosy.\n- **Budynki do przechowywania** — silosy, śrutowniki, chłodnie.\n- **Technologie rolnictwa precyzyjnego** — GPS, ISOBUS, aplikacja dawkowania zmiennego.\n- **Nawadnianie** — inwestycje w systemy irygacyjne. **Stawki dotacji** (procent kosztów kwalifikowalnych, 2024):\n- **50 %** — produkcja roślinna.\n- **60 %** — produkcja zwierzęca (premia dobrostan).\n- **+10 % dla młodych rolników** (do 40 lat, pierwsze 5 lat od rozpoczęcia działalności).\n- **+10 % dla stref ANC** (obszary o niekorzystnych warunkach).\n- **+5 % za współpracę** (między gospodarstwami / z jednostkami badawczymi). Maksymalna stawka łącznie: **80 % kosztów kwalifikowalnych**. **Ograniczenia**:\n- **Maszyny mobilne** (ciągniki, kombajny) — maks. 49 % kosztów kwalifikowalnych z całego projektu. Reszta musi stanowić budynki / stałe technologie.\n- **Maksymalna dotacja na projekt**: 1–10 mln zależnie od wielkości gospodarstwa.\n- **Maksymalna dotacja na wnioskodawcę w okresie**: 30 mln 2023–2027. **Procedura wnioskowania**:\n1. **Przygotowanie projektu** — projekt, biznesplan, ocena ekonomiczna.\n2. **Ogłoszenie naboru** (typowo 2× rocznie) — SZIF publikuje warunki.\n3. **Złożenie** przez Portal Rolnika w oknie 3–4-tygodniowym.\n4. **Ocena** (3–6 miesięcy) — punktowa ocena projektu.\n5. **Decyzja** — pozytywna / odroczona / odrzucona.\n6. **Realizacja** (1–3 lata) — zakup maszyn, budowa, dokumentacja.\n7. **Wniosek końcowy o płatność** — wypłata dotacji po udokumentowaniu inwestycji. **Praktyczne wskazówki**:\n- **Konsultant** specjalizujący się w PRV wyraźnie zwiększa szansę zatwierdzenia (według stawki ogłoszonej przez ARiMR na dany rok za projekt). W umowie zazwyczaj 2–5 % dotacji = premia za sukces.\n- **Timing**: kupuj sprzęt **po zatwierdzeniu dotacji**, nie przed. Przed zatwierdzeniem = koszt nieuznany.\n- **Dokumentacja**: faktury, umowy, dokumentacja fotograficzna przebiegu, dowód opłacalności ekonomicznej. **Ryzyko**: niespełnienie warunków (np. eksploatacja maszyny min. 5 lat, jakość budowy) = **zwrot dotacji z odsetkami**. Standardowo kontrolowane przez SZIF w ostatnich latach.",
    "alias": [
