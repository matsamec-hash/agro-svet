...
export const SLOVNIK_SK: SlovnikTerm[] = [
  ...
  },
  {
    ...
    "kategorie": "dotace",
    "shortDef": "SP SZP 2023–2027 je národná implementácia EU Spoločnej poľnohospodárskej politiky pre Slovensko. Definuje všetky dotačné tituly (priame platby, AEKO, investície).",
    "longDef": "Strategický plán Spoločnej poľnohospodárskej politiky (SP SZP) je záväzný dokument schválený EU komisiou pre každý členský štát zvlášť na obdobie 2023–2027. **Pre Slovensko** definuje rozpočet ~110 mld Kč na 5-ročné obdobie a všetky dotačné tituly.\n\n**Štruktúra SP SZP Slovensko**:\n\n### Pilier I — Priame platby (~50 % rozpočtu):\n- **BISS** (Základná platba) ~2150 Kč/ha\n- **CISS** (Redistributívna) ~1450 Kč/ha pre prvých 150 ha\n- **EKO režim** základný 1300 + premium +1100 Kč/ha\n- **ANC** (menej priaznivé) 2000–4500 Kč/ha\n- **Mladý poľnohospodár** +1500 Kč/ha bonus\n- **VCS** (citlivé sektory) — variabilné\n\n### Pilier II — Rozvoj vidieka (PRV):\n- **AEKO** zmluvy (5-ročné agro-environmentálne)\n- **Investičné tituly** (Intervencia 33.73, 37.73, ad.)\n- **LFA** (Less Favoured Areas — prekryté s ANC)\n- **Welfare zvierat** osobitné platby\n- **Bio prémie** pre ekologické poľnohospodárstvo\n- **Poistenie úrody** (50 % spoluúčasť štátu)\n\n**Kľúčové intervencie** (číselné označenie v SP SZP):\n- **33.73** — Investície do poľnohospodárskych podnikov (technika, stavby).\n- **37.73** — Technológie znižujúce emisie (hnojenie s nižším NH₃).\n- **47.73** — Pozemkové úpravy.\n- **51.73** — Mladí poľnohospodári — jednorazová podpora na zahájenie.\n- **75.73** — AEKO trávne porasty.\n\n**Dokumentácia pre žiadateľov**:\n- **Hlavný dokument**: https://eagri.cz/web/mze/dotace/sp-szp-2023-2027\n- **SZIF Pravidlá** pre každý titul zvlášť — vždy overiť aktuálnu verziu (mení sa ročne).\n- **Portál farmára** — elektronické podanie všetkých žiadostí.\n\n**Pre slovenských farmárov**:\n- **Jednotná žiadosť** (apríl–jún) pokrýva väčšinu priamych platieb.\n- **Investičné dotácie** majú vlastné kolá (typicky 2× ročne).\n- **AEKO zmluvy** sa uzatvárajú na 5 rokov — vstup je dlhodobé rozhodnutie.\n\n**Kontroly**: SZIF kontroluje 1–5 % žiadateľov na mieste + satelitný monitoring (Copernicus SISAEC) celého LPIS každý rok.",
    "related": [
      "cap-2024",
      "biss",
      "aeko",
  ...
  },
  {
    ...
    "term": "Intervencia 33.73 (Investície do poľnohospodárskych podnikov)",
    "alias": [
    ...
    "kategorie": "dotace",
    "shortDef": "Intervencia 33.73 je hlavná investičná dotácia v Slovensku — pokrýva nákup techniky, stavby, technológie. Sadzba 50–60 % oprávnených výdavkov, 10 % bonus pre mladých poľnohospodárov.",
    "longDef": "Intervencia 33.73 je najdôležitejšia investičná dotácia pre slovenských poľnohospodárov. Kryje:\n\n**Oprávnené výdavky**:\n- **Stroje a technika** — traktory, kombajny, secie stroje, postrekovače, lisy, zberné mlátičky, manipulátory.\n- **Stavby pre živočíšnu výrobu** — stáje, dojírne, sila.\n- **Stavby pre skladovanie** — silá, šrotovne, mrazírne.\n- **Technológie precízneho poľnohospodárstva** — GPS, ISOBUS, variabilné dávkovanie.\n- **Závlahy** — investície do zavlažovacích systémov.\n\n**Sadzby dotácie** (percento z oprávnených výdavkov, 2024):\n- **50 %** — rastlinná výroba.\n- **60 %** — živočíšna výroba (welfare bonus).\n- **+10 % pre mladých poľnohospodárov** (do 40 rokov, prvých 5 rokov od zahájenia činnosti).\n- **+10 % pre zóny ANC** (menej priaznivé oblasti).\n- **+5 % pre spoluprácu** (medzi farmami / s výskumom).\n\nMaximálna sadzba kumulovane: **80 % oprávnených výdavkov**.\n\n**Obmedzenia**:\n- **Mobilné stroje** (traktory, kombajny) — max 49 % oprávnených výdavkov z celého projektu. Zvyšok musí byť stavby / pevná technológia.\n- **Strop dotácie na projekt**: 1–10 mil. Kč podľa veľkosti farmy.\n- **Strop dotácie na žiadateľa za obdobie**: 30 mil. Kč 2023–2027.\n\n**Postup žiadosti**:\n1. **Príprava projektu** — návrh, podnikateľský plán, ekonomické vyhodnotenie.\n2. **Vyhlásenie kola** (typicky 2× ročne) — SZIF zverejní podmienky.\n3. **Podanie** cez Portál farmára v rámci 3-4 týždňového okna.\n4. **Hodnotenie** (3–6 mesiacov) — bodové hodnotenie projektu.\n5. **Rozhodnutie** — pozitívne / odložené / zamietnuté.\n6. **Realizácia** (1–3 roky) — nákup techniky, stavba, dokumentácia.\n7. **Záverečná žiadosť o platbu** — vyplatenie dotácie po preukázaní investície.\n\n**Praktické tipy**:\n- **Konzultant** špecializovaný na PRV výrazne zvyšuje šancu schválenia (3 000–15 000 Kč za projekt). V zmluve zvyčajne 2–5 % z dotácie = úspešnostný bonus.\n- **Časovanie**: kupujte techniku až **po schválení dotácie**, nie pred. Pred schválením = neuznateľný výdavok.\n- **Dokumentácia**: faktúry, zmluvy, fotodokumentácia priebehu, ekonomická preukázateľnosť.\n\n**Riziko**: nesplnenie podmienok (napr. prevádzkovanie stroja min. 5 rokov, kvalita stavby) = **vrátenie dotácie s úrokmi**. Štandardne auditované SZIF v posledných rokoch.",
    "related": [
      "sp-szp-2023-2027",
      "cap-2024",
      "aeko"
  ...
  },
  {
    ...
    "term": "ČMSCH",
    "alias": [
      "Českomoravská spoločnosť chovateľov",
      "ústredná evidencia včelstiev"
    ],
    "kategorie": "vcelarstvi",
    "shortDef": "ČMSCH (Českomoravská spoločnosť chovateľov, a.s.) je ústredný evidenčný a registračný orgán včelstiev na Slovensku — každý chovateľ je povinný hlásiť počty včelstiev a stanovište do ČMSCH. Hlavnou záujmovou organizáciou včelárov je Slovenský zväz včelárov (SZV).",
    "longDef": "Českomoravská spoločnosť chovateľov, a.s. (ČMSCH) prevádzkuje Ústrednú evidenciu hospodárskych zvierat (UEHO). V oblasti včelárenia to znamená, že každý chovateľ musí nahlásiť do ČMSCH svoje stanovištia a počty včelstiev — tieto údaje slúžia pre veterinárny dohľad (monitoring nákaz, varroáza) a pre výpočet dotačných nárokov zo SZIF.\n\nHlavnou záujmovou organizáciou združujúcou včelárov je Slovenský zväz včelárov (SZV), ktorý zabezpečuje vzdelávanie, poradenstvo, poistenie a zastupovanie záujmov včelárov voči štátnym orgánom. SZV má krajské a miestne organizácie po celom Slovensku.\n\nŠľachtiteľský program a vedenie plemennej knihy pre včelu medonosnú koordinuje Slovenský zväz chovateľov včely medonosnej (SZCHV) v spolupráci s overovacími stanicami. Program zahŕňa hodnotenie výnosnosti, kľudnosti, rojivosti a VSH hygieny (Varroa Sensitive Hygiene).\n\nDotácie pre včelárov na Slovensku sú spravované SZIF v rámci národných podpor — najmä dotácie na prezimovanie včelstiev a opatrenia na boj s varroázou.",
    "related": [
      "vcelstvo",
      "varroaza",
      "zazimovani"
