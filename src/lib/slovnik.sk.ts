...
export const SLOVNIK_SK: SlovnikTerm[] = [
  ...
  },
  {
    ...
    "longDef": "Spoločná poľnohospodárska politika (SZP, EN: CAP — Common Agricultural Policy) je hlavný finančný nástroj EÚ pre podporu poľnohospodárstva. Aktuálne obdobie 2023–2027 prinieslo zásadnú reformu — viac dôrazu na ekologiu (greening), redistribúciu v prospech menších fariem a zachovanie prírodných zdrojov. Hlavné složky pre SR (orientačné sadzby 2024):\n1. **BISS** (Basic Income Support for Sustainability) — Základná platba, podľa sadzby vyhlásenej PPA na daný rok na všetky spôsobilé plochy.\n2. **CISS** (Complementary Redistributive Income Support) — Redistributívna platba, podľa sadzby vyhlásenej PPA na daný rok pre prvých 150 ha. Podporuje malé farmy.\n3. **EKO-platba** (Eco-scheme) — Základnápodľa sadzby vyhlásenej PPA na daný rok, premiumpodľa sadzby vyhlásenej PPA na daný rok za viac eko-praktík (meziplodiny, biopásy, neproduktivní plochy).\n4. **ANC** (Areas with Natural Constraints) — Menej priaznivé oblasti, horskápodľa sadzby vyhlásenej PPA na daný rok, OA/SVpodľa sadzby vyhlásenej PPA na daný rok.\n5. **Mladý poľnohospodár** — Bonuspodľa sadzby vyhlásenej PPA na daný rok pre prvých 150 ha (do 40 rokov, max 5 rokov).\n6. **VCS** (Voluntary Coupled Support) — Citlivé sektory: chmeľpodľa sadzby vyhlásenej PPA na daný rok, polná zeleninapodľa sadzby vyhlásenej PPA na daný rok, cukrová repapodľa sadzby vyhlásenej PPA na daný rok, ovociepodľa sadzby vyhlásenej PPA na daný rok, zemiaky na škrobpodľa sadzby vyhlásenej PPA na daný rok, bielkovinypodľa sadzby vyhlásenej PPA na daný rok, ľanpodľa sadzby vyhlásenej PPA na daný rok, krmnépodľa sadzby vyhlásenej PPA na daný rok. Žiadosť sa podáva jednorazovo v Jednotnej žiadosti (typicky apríl–jún, podáva sa elektronicky cez Portál farmára SZIF). Záväzné sadzby SZIF zverejňuje po uzávierke kampane. Pre orientačný výpočet: [Kalkulačka dotácií CAP](/kalkulacka/dotacie-cap/).",
    "related": [
      "eko-platba",
      "mezi-plodiny",
      "biopasy"
  ...
  },
  {
    ...
    "kategorie": "dotace",
    "shortDef": "EKO-platba je časť CAP 2024 podporujúca ekologické praktiky. Základná aj prémiová sadzba sa vyhlasujú na každý rok zvlášť; prémiová sa poskytuje za viac eko-opatrení.",
    "longDef": "EKO-platba (Eco-scheme) je dobrovoľná časť priamych platieb CAP 2024, ktorá odmeňuje poľnohospodárov za environmentálne prínosné praktiky nad rámec povinných podmienok. Dva režimy v SR:\n1. **Základný EKO režim** — podľa sadzby vyhlásenej PPA na daný rok. Povinné opatrenia ako pestrá rotácia plodín, sankcie za monokultúry, dodržiavanie krajinných prvkov.\n2. **Premium EKO režim** — podľa sadzby vyhlásenej PPA na daný rok. Vyžaduje navyše: - Min. 7 % EFA (Ecological Focus Areas) z ornej pôdy — meziplodiny + biopásy + krajinné prvky. - Pásové pravidlá pozdĺž vodotečí (min. 3 m bez pesticídov). - Kvalitné krycie plodiny alebo strnisko cez zimu. Bez aspoň základného EKO režimu farma stráca významnú časť priamych platieb — preto je v praxi 95+ % poľnohospodárov v EKO režime. Pre výpočet: rozdiel medzi základom a premium jepodľa sadzby vyhlásenej PPA na daný rok. U farmy 200 ha =podľa sadzby vyhlásenej PPA na daný rok navyše. Ak zavedenie premium praktík (osivo meziplodín, výsev, kosenie biopásov) stojí <podľa sadzby vyhlásenej PPA na daný rok, oplatí sa. V praxi výnos premium praktík ide nahor (lepšia pôda, menej erózií stratené orničnej vrstvy) — net pozitívny aj bez dotačnej prémie u dlhodobej farmy.",
    "related": [
      "cap-2024",
      "mezi-plodiny",
      "biopasy"
  ...
  },
  {
    ...
    "kategorie": "dotace",
    "shortDef": "BISS je hlavná priama platba CAP 2024 — podľa sadzby vyhlásenej PPA na daný rok na všetku spôsobilú poľnohospodársku plochu. Nahradila predchádzajúcu SAPS.",
    "longDef": "BISS (Basic Income Support for Sustainability) je základná priama platba CAP 2024 — nahrádza predchádzajúcu SAPS (Single Area Payment Scheme). Vypláca sa na všetku spôsobilú poľnohospodársku plochu evidovanú v LPIS. Sadzba 2024: podľa sadzby vyhlásenej PPA na daný rok. Pre farmu 100 ha =podľa sadzby vyhlásenej PPA na daný rok len BISS, plus ďalšie zložky (CISS, EKO, ANC, VCS) dohromadypodľa sadzby vyhlásenej PPA na daný rok. Podmienky pre nárok:\n1. **Aktívny poľnohospodár** — pravidelná poľnohospodárska činnosť, nie len \"držať pôdu\".\n2. **Žiadosť cez Jednotnú žiadosť SZIF** — apríl–jún, elektronicky cez Portál farmára.\n3. **Min. výmera 1 ha** — pod tým sa nárok neuplatňuje.\n4. **Kondicionality** — povinné praktiky GAEC + povinné požiadavky riadenia SMR (welfare, pôda, voda). Vyplácanie: SZIF vypláca v jesenných termínoch (typicky október–december) za predchádzajúcu kampaň. Pri kontrole na mieste a zistení nezrovnalostí môže byť sankcia 1–100 % aj s vrátením predchádzajúcich platieb. Pre orientačný výpočet vašej celkovej dotácie: [Kalkulačka dotácií CAP](/kalkulacka/dotace-cap/).",
    "related": [
      "cap-2024",
      "lpis",
      "eko-platba"
  ...
  },
  {
    ...
    "longDef": "AEKO (Agro-environmentálne klimatické opatrenia) je samostatný dotačný program v CAP 2024, ktorý odmeňuje 5-ročné záväzky k ekologicky šetrným praktikám. Vyššie sadzby než EKO režim, ale tvrdšie pravidlá a sankcie za porušenie. Hlavné AEKO opatrenia v SR 2024:\n- **Ošetrovanie trávnych porastov (TTP)** — kosenie v neskorších termínoch (po hniezdení vtákov),podľa sadzby vyhlásenej PPA na daný rok podľa subtypu.\n- **Biopásy** — kvitnúce zmesi na poli, podľa sadzby vyhlásenej PPA na daný rok (viac než EFA).\n- **Biokoridor** — súvislé línie krajinné zelene,podľa sadzby vyhlásenej PPA na daný rok.\n- **Ekologické poľnohospodárstvo (EZ)** — certifikované bio, dodatočné sadzby na hektár podľa plodiny.\n- **Trvalá pastva** —podľa sadzby vyhlásenej PPA na daný rok podľa ANC kategórie.\n- **Vyššie zatravnenie ornej pôdy** — prevod ornej na TTP, kompenzácia stratených tržieb.\n- **Sady extenzívnych ovocných druhov** —podľa sadzby vyhlásenej PPA na daný rok. Pravidlá:\n- **5-ročná zmluva** — porušenie = vrátenie dotácie za všetky predchádzajúce roky.\n- **Inkompatibility** — niektoré subtypy nie je možné kombinovať (napr. AEKO TTP + intenzívna pastva).\n- **Kontrola na mieste** — SZIF inšpekcia 5–10 % žiadateľov ročne + diaľkový prieskum. Pre SR farmára:\n- AEKO sa vyplatí, ak má poľnohospodár dlhodobú stratégiu (zameranie na bio, krajinotvorbu, ochranu vodných zdrojov).\n- Pre klasickú intenzívnu farmu býva ROI horšie než EKO premium (viac paperwork, vyššie riziko sankcií).\n- Žiadateľom odporúčame najprv podať **EKO režim premium** a potom postupne pridávať AEKO subtypy podľa možností.",
    "related": [
      "cap-2024",
      "eko-platba",
      "biopasy"
  ...
  },
  {
    ...
    "longDef": "**Finančný leasing** = prenájom s povinnou opciou odkupu na konci (typicky za 1–5 % zvyškových nákladov). **Operatívny leasing** = prenájom bez opcie, na konci stroj vraciate. Vhodný pre krátke obdobie (3–5 rokov), bez starostí o predaj. **Bankový úver** = klasická pôžička, stroj je hneď váš, ručíte zástavou. | | Finančný leasing | Operatívny leasing | Bankový úver |\n|---|---|---|---|\n| **Vlastníctvo počas** | leasingovka | leasingovka | vy (zástava banke) |\n| **Vlastníctvo po splatení** | vy | leasingovka | vy |\n| **DPH** | rozložené po splátkach | len na splátky (vždy) | celé vopred |\n| **Akontácia** | 0–30 % | 0–30 % | 0–20 % |\n| **Sadzba (2026)** | 5,5–8 % p.a. | 6–9 % p.a. | 5–7 % p.a. |\n| **Doba** | 24–84 mesiacov | 24–60 mesiacov | 12–96 mesiacov |\n| **Flexibilita** | nízka (penalty za predčasné ukončenie) | nízka | vyššia (refinancovanie) | **Pre SK farmárov**:\n- **Finančný leasing** je štandard pre 70 % nákupov — predvídateľnosť splátok, daňová optimalizácia.\n- **Úver** sa vyplatí pre **drahé stroje 5+ mil. ** s vysokou akontáciou — nižší celkový úrok.\n- **Operatívny leasing** je výnimočný — vhodný pre **podnikateľov v zberových službách**, kde stroj 5 rokov intenzívne využíva a potom vracia. **Captive financovanie značky** (John Deere Financial, AGROTEC FS, AGRI CS Finance):\n- Často akčné sadzby 4–6 % na nové stroje vlastnej značky.\n- Spojené s predajcom — výhodné kombinovať so zľavou na cene stroja.\n- Pre ojazdené stroje zvyčajne vyššie sadzby ako univerzálne banky. → [Kalkulačka leasingu traktora](/kalkulacka/leasing-traktoru/) pre orientačný výpočet mesačnej splátky.",
    "related": [
      "cap-2024"
    ]
  },
  ...
  },
  {
    ...
    "longDef": "Strategický plán Spoločnej poľnohospodárskej politiky (SP SPP) je záväzný dokument schválený Európskou komisiou pre každý členský štát zvlášť na obdobie 2023–2027. Pre Slovensko ho pripravilo Ministerstvo pôdohospodárstva a rozvoja vidieka SR a administruje Pôdohospodárska platobná agentúra (PPA). **Štruktúra plánu**: ### Pilier I — priame platby:\n- **Základná podpora príjmu (BISS)** na hektár\n- **Redistributívna platba (CRISS)** zvýhodňujúca menšie výmery\n- **Ekoschémy** — dobrovoľné režimy pre klímu a životné prostredie\n- **ANC** — platba pre oblasti s prírodnými obmedzeniami\n- **Podpora pre mladých poľnohospodárov**\n- **Viazané platby (VCS)** pre citlivé sektory ### Pilier II — rozvoj vidieka:\n- **Agroenvironmentálno-klimatické opatrenia** (viacročné záväzky)\n- **Investičné intervencie** (technika, stavby, technológie)\n- **Ekologické poľnohospodárstvo**\n- **Welfare zvierat**\n- **Podpora poistenia produkcie** ‼️ **Sadzby na hektár sa medzi členskými štátmi líšia** a vyhlasujú sa pre každý rok zvlášť — na Slovensku v eurách. Aktuálne sadzby, stropy a termíny zverejňuje PPA; české sadzby prevzaté z materiálov SZIF pre Slovensko neplatia. **Dokumentácia pre žiadateľov**:\n- **Hlavný dokument**: Strategický plán SPP SR na stránkach MPRV SR (mpsr.sk)\n- **Príručky a výzvy**: PPA (apa.sk) — pre každý titul zvlášť, verzia sa mení\n- **Portál farmára** — elektronické podanie žiadostí **Priebeh roka**:\n- **Jednotná žiadosť** (jarný termín) pokrýva väčšinu priamych platieb\n- **Investičné výzvy** majú vlastné kolá vyhlasované PPA\n- **Viacročné záväzky** sa uzatvárajú na niekoľko rokov — vstup je dlhodobé rozhodnutie **Kontroly**: PPA overuje žiadosti administratívne, kontrolou na mieste a plošným satelitným monitoringom plôch (systém AMS nad dátami Copernicus/Sentinel).",
    "related": [
      "cap-2024",
      "biss",
      "aeko",
  ...
  },
  {
    ...
    "longDef": "Investičné intervencie sú hlavným nástrojom Strategického plánu SPP na modernizáciu poľnohospodárskych podnikov. Typicky kryjú: **Oprávnené výdavky**:\n- **Stroje a technika** — traktory, kombajny, sejačky, postrekovače, lisy, manipulátory.\n- **Stavby pre živočíšnu výrobu** — maštale, dojárne.\n- **Stavby pre skladovanie** — silá, šrotovne, chladiarne.\n- **Technológie precízneho poľnohospodárstva** — GPS, ISOBUS, variabilné dávkovanie.\n- **Závlahy** — investície do zavlažovacích systémov. **Miera podpory** sa odvíja od typu výroby a žiadateľa; bonusy sa spravidla poskytujú mladým poľnohospodárom a pre oblasti s prírodnými obmedzeniami. Presné percentá, stropy na projekt aj na žiadateľa a prípadné obmedzenie podielu mobilných strojov určujú **podmienky konkrétnej výzvy PPA** — nie sú to trvalé hodnoty a medzi kolami sa menia. **Postup žiadosti**:\n1. **Príprava projektu** — návrh, podnikateľský plán, ekonomické vyhodnotenie.\n2. **Vyhlásenie výzvy** — PPA zverejní podmienky a termín príjmu.\n3. **Podanie** cez Portál farmára v stanovenom okne.\n4. **Hodnotenie** — administratívna kontrola a bodovanie projektu.\n5. **Rozhodnutie** o schválení.\n6. **Realizácia** — nákup techniky alebo stavba podľa projektu.\n7. **Žiadosť o platbu** — preplatenie po preukázaní investície. **Praktické upozornenia**:\n- **Časovanie**: techniku kupujte až **po schválení**, nie pred ním — skorší výdavok býva neoprávnený.\n- **Dokumentácia**: faktúry, zmluvy, doklady o úhrade, fotodokumentácia priebehu.\n- **Riziko**: nesplnenie podmienok (napríklad minimálna doba prevádzkovania stroja) znamená **vrátenie podpory**, spravidla s úrokom. ‼️ Označenie **33.73** je kód českej intervencie v Strategickom pláne ČR, ktorý administruje SZIF. Na Slovensku majú výzvy vlastné číslovanie a vlastné podmienky — pri čítaní českých zdrojov je nutné s týmto rozdielom počítať.",
    "related": [
      "sp-szp-2023-2027",
      "cap-2024",
      "aeko"
