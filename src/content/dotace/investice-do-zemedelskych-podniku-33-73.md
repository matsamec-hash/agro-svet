---
name: "Investice do zemědělských podniků (33.73)"
slug: "investice-do-zemedelskych-podniku-33-73"
intervence: "33.73"
popis: "Hlavní investiční dotační titul Strategického plánu SZP 2023–2027 pro nákup zemědělské techniky, technologií a staveb. Až 50–60 % způsobilých výdajů, strop 30 mil. Kč na projekt."
...
highlights:
  ...
  - "Mobilní stroje (traktory, sklízeče) max. 49 % způsobilých výdajů projektu"
  - "Bonifikace +10 % pro mladé začínající zemědělce"
  - "Příjem žádostí typicky 2× ročně — jaro a podzim"
faq:
  - q: "Kolik procent dotace dostanu na traktor?"
    a: "Sazba je 50 % způsobilých výdajů pro rostlinnou výrobu a 60 % pro živočišnou. Pozor ale na klíčové omezení: výdaje na mobilní stroje (traktory, sklízeče, samojízdné postřikovače) smí tvořit maximálně 49 % způsobilých výdajů celého projektu. Traktor samotný tedy nelze plně dotovat — projekt musí obsahovat i jiné investice. Výjimku mají hospodářství do 150 hektarů."
  - q: "Jaký je maximální a minimální objem projektu?"
    a: "Maximální výše dotace je 30 milionů Kč na jeden projekt. Minimální způsobilé výdaje musí být alespoň 250 tisíc Kč. Mezi těmito hranicemi se pohybuje většina projektů na nákup techniky pro střední a větší farmy."
...
- **50 %** způsobilých výdajů pro rostlinnou výrobu
- **60 %** způsobilých výdajů pro živočišnou výrobu
- **+10 %** bonifikace pro mladé začínající zemědělce

Strop dotace je **30 milionů Kč na projekt**, minimální způsobilé výdaje **250 tisíc Kč**.

## Pravidlo 49 % na mobilní stroje

Klíčové omezení, které mnoho žadatelů překvapí: výdaje na **mobilní stroje** — traktory, sklízecí mlátičky, samojízdné postřikovače — smí tvořit **maximálně 49 % způsobilých výdajů** celého projektu.

V praxi to znamená, že traktor samotný nelze plně dotovat. Projekt musí obsahovat i jiné investice — nesené nářadí, stavby, technologie. Výjimku mají menší hospodářství do 150 hektarů.

## Kdo může žádat

Žadateli jsou zemědělští podnikatelé evidovaní podle **zákona č. 252/1997 Sb.** — fyzické i právnické osoby provozující zemědělskou výrobu.
